...
<div style="height:400px; width:600px; margin:auto; margin-top:50px; margin-bottom:50px; border:2px solid blue;">
...
<table cellpadding="0" cellspacing="0" width="500px" class="tableborder" style="margin:auto" >
   ...
   <tr><td class="lefttd">Select camp </td><td><select name="s3" required><option value="">Select </option>
   	<option value="">Kesor Alo Blood Donation </option>
<?php
$cn=makeconnection();
$s="select * from camp";
...
<div class="footer">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by Rokib |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
